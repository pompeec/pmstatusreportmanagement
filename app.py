...
def metric_tile(col, label: str, key: str, note: str):
    if col.button(label, use_container_width=True, key=f"tile_{key}"):
...
metric_tile(c1, "Highlights", "highlights", "Click to focus")
metric_tile(c2, "Timeline", "timeline", "Click to focus")
metric_tile(c3, "Risks", "risks", "Click to focus")
metric_tile(c4, "Decisions", "decisions", "Click to focus")
metric_tile(c5, "Metrics", "metrics", "Click to focus")
